App = {
  ...
  render: function() {
    ...
    App.contracts.Grade.deployed().then(function(instance3) {
      ...
      gradeInstance3.bm(2).then(function(bms) {
        var name = bms[2];
        //var ic = student[2];
      ...
      for (var i = 2; i <= 2; i++) {
        gradeInstance3.bm(i).then(function(bms) {
          var bmid = bms[0];
          var studentid = bms[1];
  ...
  submitGrade: function() {
    ...
    //var studId = 1;
    App.contracts.Grade.deployed().then(function(instance3) {
      return instance3.grade(subjectId, subjectMarks, { from: App.account });
    }).then(function(marks) {
