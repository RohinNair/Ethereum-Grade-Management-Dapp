App = {
    ...
    App.contracts.Grade.deployed().then(function(instance2) {
      ...
      for (var i = 1; i <= 1; i++) {
        gradeInstance2.bi(i).then(function(bis) {
          ...
          var studentTemplate = "<tr><th>" + biid + "</th><td>" + studentid + "</td><td>" + studentName + "</td><td>" + marks + "</td><td>" + grade + "</td></tr>"
  ...
  submitGrade: function() {
    ...
    //var studId = 1;
    App.contracts.Grade.deployed().then(function(instance2) {
      return instance2.gradeBI(subjectId, subjectMarks, { from: App.account });
    }).then(function(marks) {
